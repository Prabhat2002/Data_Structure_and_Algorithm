 string numberToWords(int num) 
    {
          ...
          string TENS[10]= {"","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"};//means that if tens position is zero no need to write the word
